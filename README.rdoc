...
Another available helper method is +increment!(key)+.
It works like $COUNT, but returns an integer and can be assigned an arbitrary key that is unrelated to the model.
